...
namespace QualitySensorData.Controllers
{
    ...
    [ApiController]
    public class FloorConsumption : ControllerBase
    {
        ...
        public FloorConsumption(QualitySensorDbContext dataset) //, ILogger<AQMSapiDbContext> logger
        {
        ...
        [HttpGet("floor")]
        public IActionResult FloorWiseConsumption(int floor)
        {
            try
            {
                //_logger.LogInformation("-------********************-------getting all data-------****************-------");
